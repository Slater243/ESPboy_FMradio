...
ADC_MODE(ADC_VCC);                        // add this line
...
//draw RDS
  ...
  myESPboy.tft.setCursor(75, 120);                             // add this line
  myESPboy.tft.print("  B:");                                  // add this line
  myESPboy.tft.print(map(ESP.getVcc (), 2700, 4200, 0, 100));  // and this
  myESPboy.tft.print("%");                                     // and this
}
...
// Enables SDR
  radio.setRds(true);
  radio.setRdsMode(0); 
  radio.setSeekThreshold(18); // Sets RSSI Seek Threshold (0 to 127)
